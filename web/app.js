...
(function (root, factory) {
  ...
  pdfFindControllerLib, pdfFindBarLib, domEventsLib, pdfjsLib, multiPageViewLib) {
  ...
  var PDFViewerApplication = {
    ...
    bindEvents: function pdfViewBindEvents() {
      ...
      eventBus.on('onePageView', toggleOnePageView);
      eventBus.on('multiPageView', toggleMultiPageView);
