...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define('pdfjs-web/app', ['exports', 'pdfjs-web/ui_utils',
      ...
      'pdfjs-web/dom_events', 'pdfjs-web/multi_page_view', 'pdfjs-web/pdfjs'],
      factory);
    ...
    factory(exports, require('./ui_utils.js'), require('./download_manager.js'),
      ...
      require('./dom_events.js'), require('./multi_page_view.js'),
      require('./pdfjs.js'));
  } else {
    factory((root.pdfjsWebApp = {}), root.pdfjsWebUIUtils,
      ...
      root.pdfjsWebDOMEvents, root.pdfjsWebMultiPageView,
      root.pdfjsWebPDFJS);
  }
                  ...
                  pdfFindControllerLib, pdfFindBarLib, domEventsLib,
                  multiPageViewLib, pdfjsLib) {
...
var MultiPageView = multiPageViewLib.MultiPageView;
...
var PDFViewerApplication = {
  ...
  _initializeViewerComponents: function () {
    ...
    return new Promise(function (resolve, reject) {
      ...
      self.multiPageView = new MultiPageView({
        container: container,
        viewer: viewer,
        eventBus: eventBus,
  ...
  bindEvents: function pdfViewBindEvents() {
    ...
    eventBus.on('onePageView', webViewerOnePageView);
    eventBus.on('multiPageView', webViewerMultiPageView);
...
function webViewerMultiPageView() {
  PDFViewerApplication.multiPageView.multiPageView();
...
function webViewerNextPage() {
  if (PDFViewerApplication.multiPageView.multiPage) {
    PDFViewerApplication.page = PDFViewerApplication.multiPageView.nextPage(PDFViewerApplication.page, PDFViewerApplication.pagesCount);
  } else {
...
function webViewerPreviousPage() {
  if (PDFViewerApplication.multiPageView.multiPage) {
    PDFViewerApplication.page = PDFViewerApplication.multiPageView.previousPage(PDFViewerApplication.page);
  } else {
    PDFViewerApplication.page--;
  }
}
